-- XOVA DATABASE SETUP - FIXED VERSION
-- This version fixes the trigger syntax errors
...
CREATE TABLE IF NOT EXISTS ingredients (
  ...
  -- Cost & Availability
  cost_per_100g DECIMAL(6,2) NOT NULL,
  density DECIMAL(4,2) DEFAULT 1.0,
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  -- Selected Smoothies
  selected_smoothies JSONB NOT NULL,
...
CREATE TABLE IF NOT EXISTS subscriptions (
  ...
  -- Pricing
  price_per_smoothie INTEGER NOT NULL,
...
-- ==============================================
-- 3. ENABLE RLS (IGNORE ERRORS IF ALREADY ENABLED)
-- ==============================================
...
-- ==============================================
-- 4. CREATE POLICIES (IGNORE ERRORS IF ALREADY EXIST)
-- ==============================================
...
-- Updated At Triggers (Fixed - no IF NOT EXISTS)
...
('delivery_fee_chf', '40.00'::JSONB, 'number', 'Default delivery fee in CHF', true),
